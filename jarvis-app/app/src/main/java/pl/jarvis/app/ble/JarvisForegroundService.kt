...
/**
 * Usługa pierwszoplanowa, która trzyma proces przy życiu, gdy Jarvis nasłuchuje
 ...
 * Start/stop jest sterowany reaktywnie z [pl.jarvis.app.JarvisApplication] na
...
class JarvisForegroundService : Service() {
    ...
    private fun ensureChannel() {
        ...
        manager.createNotificationChannel(
            NotificationChannel(CHANNEL_ID, "Jarvis w tle", NotificationManager.IMPORTANCE_LOW).apply {
    ...
    companion object {
        private const val TAG = "JarvisFgService"
