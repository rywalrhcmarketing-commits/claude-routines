...
import pl.jarvis.app.OrchestratorState
import pl.jarvis.app.ui.components.ActionConfirmationDialog
import pl.jarvis.app.ui.components.ModelBadge
import pl.jarvis.app.ui.components.NewModelsBanner
...
fun MainScreen(
    ...
    val heyCyan = pl.jarvis.app.JarvisApplication.get().heyCyanManager
    val connState by heyCyan.connectionState.collectAsState()
            ...
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        ...
                        Icon(
                            if (connState == pl.jarvis.app.ble.ConnectionState.READY)
                    ...
                    val orch = pl.jarvis.app.JarvisApplication.get().orchestrator
...
private fun IdleContent(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(12.dp)) {
            ...
            Text(
                if (accessibilityMode != pl.jarvis.app.accessibility.AccessibilityMode.OFF)
            ...
            Row(
                ...
                Button(
                    ...
                    modifier = Modifier.weight(1f),
                    enabled = accessibilityMode == pl.jarvis.app.accessibility.AccessibilityMode.OFF
